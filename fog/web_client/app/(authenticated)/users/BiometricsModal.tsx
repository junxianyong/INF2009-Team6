...
export const BiometricsModal = (
  ...
  const startRecording = () => {
    ...
    navigator.mediaDevices.getUserMedia({ audio: true }).then(stream => {
      ...
      // Update timer and stop at 10 seconds
      ...
      <div className="flex flex-col py-4 gap-4">
        ...
        <div className="flex flex-col gap-2">
          <div className="relative">
            ...
            <div className={`absolute z-200 bottom-4 left-1/2 -translate-x-1/2 ${images.length >= 5 ? "hidden": ""}`}>
              <Button type="primary" shape="circle" icon={<CameraOutlined />} onClick={captureImage} size="large"/>
            </div>
          </div>
              ...
              <div key={i} className="relative flex-1">
                ...
                {images.length > i ?
                  <div className="absolute top-2 right-2">
                    <Button type="primary" icon={<DeleteOutlined />} size="small" onClick={() => deleteImage(i)} danger/>
                  </div>: <></>
                }
              </div>
            ))}
        ...
        <div>
          ...
          <Text>Record a secure 10 second voice password.</Text>
          <Divider style={{marginTop: 8, marginBottom: 0}}/>
        </div>
        <div className="flex gap-8 items-center">
          ...
          <Text>00:{String(seconds).padStart(2, "0")}/00:10</Text>
        </div>
